...
function executeCode() {
  ...
  var values = Array.from(resultMap.values());
  ...
  var output = (0, _randomNumberGenerator.checkRandomNumber)(values);
  console.log(output.status);
  return values;
}
var _default = exports.default = executeCode;
},{"./randomNumberGenerator":"src/randomNumberGenerator.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
